...
var PracticeUnderstandCell = React.createClass({
  ...
  render: function() {
    ...
    var desc = this.props.question.question || "";
    var regex = /(&nbsp;|<([^>]+)>)/ig;
        ...
        <TouchableElement
          ...
          <View style={styles.flexContainer}>
            ...
            <View style={styles.flexCell}>
              <Text style={styles.qTitle} numberOfLines={1}></Text>
...
module.exports = PracticeUnderstandCell;
