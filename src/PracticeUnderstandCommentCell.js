...
var PracticeUnderstandCommentCell = React.createClass({
...
//    this.markAsRead(this.props.question);
 //   this.props.onSelect(this.props.question)
  ...
  render: function() {
    ...
    var desc = this.props.question.comment || "";
    var regex = /(&nbsp;|<([^>]+)>)/ig;
            ...
            <View style={styles.flexCell}>
              <View style={styles.flexCreatorCell}>
                <Text style={styles.qcreatorText}>
                  ...
                  {' '}&bull;{' '}
                  <Text>{this.props.question.discussTime}</Text>                
                </Text>
              </View>            
...
module.exports = PracticeUnderstandCommentCell;
