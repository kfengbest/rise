...
var KnowledgeList = require('./KnowledgeList');
...
var PracticeDetail = React.createClass({
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.flexContainer}>
          <View style={styles.flexCell}>   
            ...
            <KnowledgeList 
              data = {this.props.practice.knowledge}
              navigator = {this.props.navigator}               
            />

            <PracticeAppliedList 
              data={this.props.practice.applied}
              navigator = {this.props.navigator}              
            />

            <PracticeUnderstandList 
              data={this.props.practice.understand}
              navigator = {this.props.navigator}
            />
